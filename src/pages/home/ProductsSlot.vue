<template>
    ...
    <div class="ml-10 flex max-w-md mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
        ...
        <div class="w-2/3 p-4 md:p-4">
            <h1 @click="toDetail" class="text-2xl font-bold text-gray-800 dark:text-white">Product {{id}}</h1>
